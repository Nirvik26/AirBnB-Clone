  ...
  return (
    ...
    <ToastContainer autoClose={3000}/>
      ...
      <div className="ml-20 mt-4">
        ...
        <div className="flex mt-5">
          ...
          <div>
            ...
            <div className="flex">
              ...
              />
              <img
                src={location.state.data.images[4]}
                alt=""
        ...
        <h1 className="text-2xl semibold mt-7">
        ...
        <hr className="mt-10" />
        <h1 className="mt-10 font-semibold text-2xl">What this place offers</h1>
        ...
        <div className="flex mt-8">
          <input
            ...
            type="tex((t"
            className="border-b-2 text-gray-900 text-lg border-gray-300 h-12 mt-7 block w-5/12 p-2.5 outline-none border-spacing-1"
            placeholder="Comments"
            required
          />
          <button
            onClick={addReview}
            className="shadown-2xl text-white bg-gray-600 w-14 h-14 border border-gray-400 ml-7"
          >
            Add
          </button>
        </div>
          ...
          {reviewData.map((data: any) => {
            return (
              ...
              {data.proImag ? <img
                  ...
                  /> : !data?.email ? <Avatar name={data.email ?? "Avatar"} size='40' round={true} textSizeRatio={1.75} /> : <Avatar src={profile} size='40' round={true}/>}
